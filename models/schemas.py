...
class ExtractRequest(BaseModel):
    ...
    url: str = Field(..., description="要抓取的URL")
    extract_type: Literal["article", "product", "links", "images"] = Field(..., description="提取类型")
    custom_schema: Optional[Dict[str, str]] = Field(None, alias="schema", description="自定义提取规则")
